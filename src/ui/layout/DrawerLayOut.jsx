...
import AuthPageSignIn from '../users/AuthPageSignIn';
import AuthPageJoin from '../users/AuthPageJoin';
import ToevoegenFiche from '../Fiche/Toevoegen';
import MijnFiches from '../Fiche/MijnFiches';
import ViewFiche from '../Fiche/View';
import EditFiche from '../Fiche/Bewerken';
		...
		return (
			<div className={classes.root}>
				...
				<div style={{position:'relative', display:'plex', width:'100%', minHeight:'100%'}}>
					...
					<Route exact path="/registreren" component={AuthPageJoin} />    
					<Route exact path="/aanmelden" component={AuthPageSignIn} />          
					...
					<PrivateRoute  exact path="/fiches/edit/:id" component={EditFiche}  />
					</div>
				</div>
			</div>
		);
